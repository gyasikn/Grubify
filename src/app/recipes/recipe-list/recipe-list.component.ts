...
export class RecipeListComponent implements OnInit {
  recipes: Recipe[] = [
    ...
    new Recipe("Wow Great Food Even Better Wow", "finger licking good...", "http://s3.amazonaws.com/finecooking.s3.tauntonclud.com/app/uploads/2017/04/18180350/051SIP112-grilled-mustard-rosemary-chicken-recipe-alt-main.jpg")
  ];
